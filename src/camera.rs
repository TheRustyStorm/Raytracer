...
impl Camera{
    pub fn new(look_from: Vector3<f32>, look_at: Vector3<f32>, vup: Vector3<f32>, vfov: f32, aspect:f32, aperture:f32, focus_dist: f32) -> Camera{
    let (u, v, w);
    ...
    Camera{lower_left: lower_left_corner, horizontal: horizontal, vertical: vertical, origin: origin, u:u, v:v, w:w, lens_radius: lens_radius}
    }
